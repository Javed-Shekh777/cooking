...
const Navbar = () => {
    ...
    return (
        <header className='max-w-screen border-b-[#E4E6F1] border-b'>
            <div className="headerWrapper flex items-center justify-between md:px-8 px-4 md:py-5 py-3.5">
                ...
                <div className="headermid">
                    <ul className="menu md:flex hidden items-center xl:gap-x-10 sm:gap-x-6 font-medium whitespace-nowrap">
                        ...
                        <li className={`memuItem px-4 py-2 hover:bg-gray-300 rounded-md hover:text-[#FF7967] duration-300 transition-all ${pathname === '/f' && 'text-[#FF7967]'}`}><a href="">About us</a></li>
                        {user
                            ? <li onClick={() => setShowProfileBar(!showProfilebar)} className={`memuItem p-1.5 relative hover:bg-gray-300 rounded-full duration-300 transition-all cursor-pointer ${pathname === '/f' && 'text-[#FF7967]'}`}>
                                ...
                                {showProfilebar && <ul className='absolute left-0 top-[110%]  bg-white p-1 w-40 rounded-md shadow gap-y-1'>
                                    <li className='memuItem px-4 py-2 hover:bg-gray-300 rounded-md   duration-300 transition-all'>Profile</li>
                                    <li className='memuItem px-4 py-2 hover:bg-gray-300 rounded-md   duration-300 transition-all'>Settings</li>
                                    <li className='memuItem px-4 py-2 hover:bg-gray-300 rounded-md  duration-300 transition-all'><a href="/chef">Services</a></li>
                ...
                <div className="headerRight flex items-center space-x-5">
                    <div className="">
